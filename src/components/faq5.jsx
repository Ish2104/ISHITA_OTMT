            ...
            <div className="popup-content">
              ...
              <Accordion>
                <AccordionSummary
                  ...
                  id="panel1-header"
                >
                  Who can benefit from the startup facilitation services?
                </AccordionSummary>
                <AccordionDetails>
              ...
              <Accordion>
                <AccordionSummary
                  ...
                  id="panel2-header"
                >
                  How do I join the Entrepreneurship Cell (ECELL)?
                </AccordionSummary>
                <AccordionDetails>
              ...
              <Accordion>
                <AccordionSummary
                  ...
                  id="panel3-header"
                >
                  What resources does the Innovation Hub (IHUB) provide for startups?
                </AccordionSummary>
                <AccordionDetails>
              ...
              <Accordion>
                <AccordionSummary
                  ...
                  id="panel4-header"
                >
                  How can I get incubation support from IITDIC?
                </AccordionSummary>
                <AccordionDetails>
              ...
              <Accordion>
                <AccordionSummary
                  ...
                  id="panel5-header"
                >
                  Are the mentorship programs tailored to specific industries?
                </AccordionSummary>
                <AccordionDetails>
